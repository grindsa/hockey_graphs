        ...
        while True:
            ...
            if data:
                try:
                    ...
                    self.print_out('RECIEVED INVALID DATA!,{0}'.format(data))
                    CONFIG_DIC['status'] = 'offline'
                    sys.exit(0)
            else:
...
# class CLIParser(argparse.ArgumentParser(description='This is a PyMOTW sample program')):
