...
if __name__ == '__main__':
    ...
    for ele in os.listdir(DATA_PATH):
        ...
        #for team in ['team-stats-home.json', 'team-stats-guest.json', 'team-stats-home.json', 'team-stats-guest.json']:
        ...
        if os.path.isdir(MATCH_DIR):
            HOME_FILE = '{0}/{1}'.format(MATCH_DIR, 'team-stats-home.json')
            VISITOR_FILE = '{0}/{1}'.format(MATCH_DIR, 'team-stats-guest.json')
            home_dic = {}
            visitor_dic = {}
            try:
                ...
                roster_id = teamstat_add(LOGGER, 'match_id', int(ele), {'match_id': int(ele), 'home': home_dic, 'visitor': visitor_dic})
