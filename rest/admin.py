...
class MatchAdmin(admin.ModelAdmin):
    """ match admin """
    fields = ['season', 'match_id', 'date', 'date_uts', 'home_team', 'visitor_team', 'result', 'result_suffix', 'finish', 'disable', 'tweet', 'prematch_tweet_id']
    list_display = ['season', 'match_id', 'date', 'date_uts', 'home_team', 'visitor_team', 'result', 'result_suffix', 'finish', 'disable', 'tweet', 'prematch_tweet_id']
    ordering = ['match_id']
...
class SeasonAdmin(admin.ModelAdmin):
    """ season admin """
    fields = ['name', 'shortcut', 'tournament', 'delname', 'playoffstart', 'delurl', 'u23year']
    list_display = ['name', 'shortcut', 'tournament', 'delname', 'playoffstart', 'delurl', 'u23year']
    ordering = ['tournament']
...
class TeamAdmin(admin.ModelAdmin):
    """ teamadmin"""
    fields = ['team_id', 'team_name', 'shortcut', 'logo', 'color_primary', 'color_secondary', 'color_tertiary', 'color_quaternary', 'color_penalty_primary', 'color_penalty_secondary', 'twitter_name', 'facebook_groups', 'bg_images']
    list_display = ['team_id', 'team_name', 'shortcut', 'logo', 'color_primary', 'color_secondary', 'color_tertiary', 'color_quaternary', 'color_penalty_primary', 'color_penalty_secondary', 'twitter_name', 'facebook_groups', 'bg_images']
    ordering = ['team_id']
